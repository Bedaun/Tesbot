const sessionName = "bebot";
const donet = "https://wa.me/085332959066";
const owner = ["62085332959066"];
const {
...
async function startHisoka() {
  ...
  client.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
      ...
      console.log(color("Donate for creator by contact ", "yellow"));
